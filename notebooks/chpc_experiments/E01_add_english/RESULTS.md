...
>
> **What changes and what survives.** Both of E01's headline Δs move at convergence, and — unlike
...
>
> The short run is not simply the long run truncated — its LR schedule is compressed into 4,000
...
**Two variables moved vs the incumbent, so use the matched control.** E01 changes the input
...
The step-1250 dip (0.7706 → 0.7551) is the only non-monotone point and it recovers fully by
