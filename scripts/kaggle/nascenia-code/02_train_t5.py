...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out-dir", default=None, help="where to write runs (Kaggle: /kaggle/working)")
    ...
    print(f"device: {gpu_name}  (n_gpu={n_gpu})" if torch.cuda.is_available()
          else "device: CPU (will be very slow)")
