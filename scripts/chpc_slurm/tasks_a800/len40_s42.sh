...
$PY ../code/02_train_t5.py --data-dir ../data/english_draft_len40 --model csebuetnlp/banglat5 \
  --out-dir . --run-name len40_s42 --seed 42 --lr 1e-3 --warmup 200 --optim adafactor \
...
$PY ../code/04_decode.py --ckpt len40_s42/best --data-dir ../data/english_draft_len40 --split dev \
  --limit 300 --mode beam --num-beams 8 --length-penalty 1.2 --min-new-tokens 0 --max-new-tokens 320 \
  --no-bertscore --record len40_s42/dev_e15dec.json
$PY ../code/04_decode.py --ckpt len40_s42/best --data-dir ../data/english_draft_len40 --split test \
  --mode beam --num-beams 8 --length-penalty 1.2 --min-new-tokens 0 --max-new-tokens 320 \
  --no-bertscore --out len40_s42/submission.csv --record len40_s42/test.json
echo "done $(date)"
