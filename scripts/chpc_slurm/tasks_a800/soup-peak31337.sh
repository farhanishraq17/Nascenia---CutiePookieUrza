...
$PY $P/code/17_model_soup.py $PK $E/sched31337/best --out peak5_31337 --data-dir $D || echo FAILED a
$PY $P/code/17_model_soup.py $PK $E/sched777/best $E/sched31337/best --out peak5_777_31337 --data-dir $D || echo FAILED b
echo done
