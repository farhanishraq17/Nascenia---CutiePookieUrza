...
$PY /scratch/general/nfs1/u1592009/Nascenia_Datathon/fine_tune_project/code/14_decode_sweep.py --ckpt /scratch/general/nfs1/u1592009/Nascenia_Datathon/fine_tune_project/E05_train_to_convergence/english_draft/best --data-dir /scratch/general/nfs1/u1592009/Nascenia_Datathon/fine_tune_project/data/english_draft \
  --beams 16 --length-penalties 1.0,1.2,1.4,1.6,1.8,2.0,2.4,2.8,3.2 --min-new 0 --max-new 320 \
  --batch-size 8 --verify-top 4 --out sweep2_champ_b16.json
echo "exit=$? $(date)"
