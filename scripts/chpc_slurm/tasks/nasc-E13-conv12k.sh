...
cd /scratch/general/nfs1/u1592009/Nascenia_Datathon/fine_tune_project/E13_multitask_qa

# ---- train ------------------------------------------------------------------
# --resume makes a requeued job pick up the last checkpoint instead of restarting.
$PY ../code/02_train_t5.py \
  --data-dir ../data/multitask_english_draft \
...
$PY ../code/04_decode.py --ckpt conv12k/best --data-dir ../data/multitask_english_draft \
