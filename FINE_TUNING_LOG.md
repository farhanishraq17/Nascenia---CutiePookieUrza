...
⚠️ **CEILING-01 is not a ceiling on this task.** It bounds a model that writes its *own* answer.
...
⚠️ **F's authoritative number is 0.2442, not 0.2444.** `run.json` records the *best checkpoint*
...
⚠️ **Despite the 0.0001 dev gap, the two seeds share only 34/1000 test rows (3.4%).** Near-identical
...
## ⚠️ Status of each folder — updated 2026-08-05

| Arm | Notebook | metadata | code | `run.json` | trajectory | prep report |
|---|---|---|---|---|---|---|
| **A** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 3000, 3180 | ✅ |
| B | ✅ | ✅ | ⚠️ from `NOTEBOOKS/` | ⛔ **cancelled** — never ran to completion | ❌ | ❌ |
| **C** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 2000, 3180 | ✅ |
| D | ✅ | ✅ | ⚠️ from `NOTEBOOKS/` | ⚠️ *transcribed* | ❌ output not downloaded | ❌ |
| **E** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 2000, 3500 | ✅ |
| **F** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 3000, 4500 | ✅ |
| **G** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ step 1500 | ✅ |
| **🏆 XFER-s11** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 2750, 3180 | ✅ |
| **XFER-s23** | ✅ | ✅ | ✅ run's own | ✅ genuine | ✅ steps 3000, 3180 | ✅ |
